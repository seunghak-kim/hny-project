...
class RealEstate(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    property_type = Column(Enum(PropertyType, native_enum=False), nullable=False, comment="부동산 종류")
...
class Transaction(Base):
    ...
    # 거래 기본 정보
    transaction_type = Column(Enum(TransactionType, native_enum=False), comment="거래 유형")

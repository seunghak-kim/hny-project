...
def chunk_apartment_management_rule_to_json(
    input_path="공동주택관리법 시행규칙(국토교통부령)(제01482호)(20250415).txt",
    output_path=None
):
    """
    공동주택관리법 시행규칙을 조 단위로 청킹하고 JSON 파일로 저장합니다.
    특징: 8개 장(Chapter)과 절(Section) 구분, 48개 조항
    """
    ...
    rule_title = title_match.group(1).strip() if title_match else "공동주택관리법 시행규칙"
...
if __name__ == "__main__":
    chunk_apartment_management_rule_to_json()
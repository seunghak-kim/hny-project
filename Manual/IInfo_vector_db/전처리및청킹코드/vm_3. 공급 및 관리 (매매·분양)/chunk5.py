...
def chunk_apartment_management_decree_to_json(
    input_path="공동주택관리법 시행령(대통령령)(제35451호)(20250415).txt",
    output_path=None
):
    """
    공동주택관리법 시행령을 조 단위로 청킹하고 JSON 파일로 저장합니다.
    특징: 11개 장(Chapter)과 절(Section) 구분, 124개 조항
    """
    ...
    decree_title = title_match.group(1).strip() if title_match else "공동주택관리법 시행령"
...
if __name__ == "__main__":
    chunk_apartment_management_decree_to_json()
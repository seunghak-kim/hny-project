...
def chunk_rental_housing_decree_to_json(
    input_path="민간임대주택에 관한 특별법 시행령(대통령령)(제35581호)(20250604).txt",
    output_path=None
):
    """
    민간임대주택에 관한 특별법 시행령을 조 단위로 청킹하고 JSON 파일로 저장합니다.
    특징: 7개 장으로 구성, 80개 조항
    """
...
if __name__ == "__main__":
    # 실제 파일 처리
    chunk_rental_housing_decree_to_json()
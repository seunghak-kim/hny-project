...
def chunk_decree_to_json(
    input_path="부동산 거래신고 등에 관한 법률 시행령(대통령령)(제35485호)(20250429).txt",
    output_path=None
):
    """
    부동산 거래신고 등에 관한 법률 시행령을 조 단위로 청킹하고 JSON 파일로 저장합니다.
    특징: 6개 장으로 구성된 시행령 구조 (제5장의2 포함)
    """
